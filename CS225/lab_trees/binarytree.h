...
class BinaryTree
{
    ...
    private:
        ...
        /**
         * Flips a tree at currNode.
         */
        void mirrorHelper(Node* currNode);
        /**
         * Switches left and right node at parent node.
         */
        void flip(Node* parent);

        bool isOrderedRecursive(Node* currNode, std::queue<typename BinaryTree<T>::Node*>& queue) const;
